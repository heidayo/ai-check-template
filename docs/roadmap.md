...
- `update` — bring known template-managed files in an existing setup up to the current package version. Foundation is available; profile-aware migration remains planned.
