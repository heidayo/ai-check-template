# TASK-0090: Verify CLI doctor strict warnings
...
| 担当Agent | Verify |
| 並列可否  | No |
| 依存TASK  | TASK-0088, TASK-0089 |
| 見積     | 35m |

## 責務

SPEC-0023 の AC-01..AC-09 を機械検証し、SPEC / PLAN / TASK status と採点欄を完了状態に更新して commit / push / PR を作成する。
...
- 変更: `specs/SPEC-0023-cli-doctor-strict-warnings.md`
- 変更: `plans/PLAN-0023-cli-doctor-strict-warnings.md`
- 変更: `tasks/TASK-0088-doctor-strict-flag.md`
- 変更: `tasks/TASK-0089-doctor-strict-tests-docs.md`
- 変更: `tasks/TASK-0090-verify-cli-doctor-strict-warnings.md`
- 削除: なし
...
- [x] SPEC-0023 AC-01..AC-09 が全 pass
...
- [x] SPEC-0023 / PLAN-0023 / TASK-0088..0090 採点が 100/S++
- [x] commit message includes `TASK-0088 TASK-0089 TASK-0090`
...
strict warnings を opt-in diagnostic gate として閉じ、severity / ignore config は follow-up に残す。
...
| フィールド | 内容 |
|-----------|------|
| RUN-ID    | 2026-05-14-spec-0023-task-0090 |
| 開始     | 2026-05-14 |
| 完了     | 2026-05-14 |
| 結果     | PASS |
