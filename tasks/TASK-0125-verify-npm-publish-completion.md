# TASK-0125: Verify npm publish completion
...
| 担当Agent | Verify |
| 並列可否  | No |
| 依存TASK  | TASK-0123, TASK-0124 |
| 見積     | 30m |

## 責務

SPEC-0033 の AC-01..AC-08 を機械検証し、SPEC / PLAN / TASK status と採点欄を完了状態に更新して commit / push / PR を作成する。

## File Scope（変更許可範囲）

- 変更: `specs/SPEC-0033-npm-publish-completion.md`
- 変更: `plans/PLAN-0033-npm-publish-completion.md`
- 変更: `tasks/TASK-0123-npm-publish-docs.md`
- 変更: `tasks/TASK-0124-npm-publish-release-note.md`
- 変更: `tasks/TASK-0125-verify-npm-publish-completion.md`
- 削除: なし
...
- package contents を変更しない
- `--no-verify`, `--force`, `rm -rf` を使わない

## 完了条件

- [x] SPEC-0033 AC-01..AC-08 が全 pass
...
- [x] SPEC-0033 / PLAN-0033 / TASK-0123..0125 採点が 100/S++
- [x] commit message includes `TASK-0123 TASK-0124 TASK-0125`

## Tests

- `npm view ai-check-template version dist-tags --json`
- `npx -y ai-check-template@next ...` smoke
...
npm alpha publish completion を docs に反映し、stable release と additional registry operations は follow-up に残す。
...
| フィールド | 内容 |
|-----------|------|
| RUN-ID    | 2026-05-16-spec-0033-task-0125 |
| 開始     | 2026-05-16 |
| 完了     | 2026-05-16 |
| 結果     | PASS |
